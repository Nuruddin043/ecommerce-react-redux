...
export default function AdminTab() {
  ...
  const allTabs = [ '/admin/product','/admin/category', '/admin/order','/admin/user'];
  return (
          ...
          render={({ location }) => (
            <>
              <Tabs value={location.pathname}>
                <Tab label="Product" value="/admin/product" component={Link} to={allTabs[0]} />
                <Tab label="Category" value="/admin/category" component={Link} to={allTabs[1]} />
              ...
              <Switch>
                ...
                <Route path={allTabs[3]} render={() => <UserDashboard />} />
              </Switch>
            </>
          )}
        />
